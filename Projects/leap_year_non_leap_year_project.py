date1 = input("Enter your starting year: ")                     # taking input from user for starting year
date2 = input("Enter your ending year: ")                       # taking input from user for ending year
d1 = date1.split("/")
d2 = date2.split("/")
y1 = int(d1[2])
y2 = int(d2[2])
